...
abstract class AppLocalizations {
  ...
  /// No description provided for @youAreNotSupposedToBeHere.
  ///
  /// In en, this message translates to:
  /// **'You are not supposed to be here'**
  String get youAreNotSupposedToBeHere;

  /// No description provided for @checkingIfLoggedIn.
  ///
  /// In en, this message translates to:
  /// **'Checking if logged in...'**
  String get checkingIfLoggedIn;
  ...
  /// No description provided for @requestingSession.
  ///
  /// In en, this message translates to:
  /// **'Requesting session...'**
  String get requestingSession;
